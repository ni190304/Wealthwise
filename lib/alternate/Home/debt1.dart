...
class Debt1 extends StatefulWidget {
  const Debt1({Key? key}) : super(key: key);

  @override
  State<Debt1> createState() => _Debt1State();
}

class _Debt1State extends State<Debt1> {
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (debtemails.isEmpty) {
              return const Center(child: Text('No debt emails available'));
            }
            ...
            return const Center(
              child: Text('No debt emails available'),
            );
          } else {
            return const Center(child: CircularProgressIndicator());
          }

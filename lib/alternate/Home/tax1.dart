...
class Tax1 extends StatefulWidget {
  const Tax1({Key? key}) : super(key: key);

  @override
  State<Tax1> createState() => _Tax1State();
}

class _Tax1State extends State<Tax1> {
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (taxemails.isEmpty) {
              return const Center(child: Text('No tax emails available'));
            }
            ...
            return const Center(
              child: Text('No tax emails available'),
            );
          } else {
            return const Center(child: CircularProgressIndicator());
          }
